<template>
    ...
    <div class="flex items-start">
        ...
        >
            <li class="nav-item flex-grow text-center" role="presentation">
                <a
                    ...
                    class="nav-link block font-medium text-xs leading-tight border-x-0 border-t-0 border-l-2 border-transparent px-6 py-3 my-2 hover:border-transparent hover:bg-gray-100 focus:border-transparent active"
            ...
            <li class="nav-item flex-grow text-center" role="presentation">
                <a
                    ...
                    class="nav-link block font-medium text-xs leading-tight border-x-0 border-t-0 border-b-2 border-transparent px-6 py-3 my-2 hover:border-transparent hover:bg-gray-100 focus:border-transparent"
            ...
            <li class="nav-item flex-grow text-center" role="presentation">
                <a
                    href="#tabs-ICT-GroupVertical"
                    class="nav-link block font-medium text-xs leading-tight border-x-0 border-t-0 border-b-2 border-transparent px-6 py-3 my-2 hover:border-transparent hover:bg-gray-100 focus:border-transparent"
                    id="tabs-ICTGroup-tabVertical"
                    data-bs-toggle="pill"
                    data-bs-target="#tabs-ICT-GroupVertical"
                    role="tab"
                    aria-controls="tabs-ICT-GroupVertical"
                    aria-selected="false"
                    >ICT Group</a
                >
            </li>
        ...
        <div class="tab-content" id="tabs-tabContentVertical">
            ...
            <div
                class="tab-pane fade"
                id="tabs-ICT-GroupVertical"
                role="tabpanel"
                aria-labelledby="tabs-profile-tabVertical"
            >
                Tab 4 content vertical
            </div>
        </div>
    </div>
</template>
